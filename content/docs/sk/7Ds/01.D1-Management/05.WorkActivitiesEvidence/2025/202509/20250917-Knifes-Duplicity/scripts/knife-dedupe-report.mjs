// knife-dedupe-report.mjs
// Cross-platform scanner for duplicate KNIFE entries (folders/files/IDs/titles/slugs).
// Zero-deps; scans docs/<lang>/knifes/**/index.md(x) and _category_.json.
